...
const clearAlerts = require('../response-handlers/foods-response-handler').clearAlerts
const clearNewFoodForm = require('../response-handlers/foods-response-handler').clearNewFoodForm
